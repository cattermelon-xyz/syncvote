        ...
        <CollapsiblePanel title='Tally Info'>
          <Space direction='vertical' size='small' className='w-full'>
            <Space direction='vertical' size='small' className='w-full'>
              ...
              <Input
                className='w-full'
                placeholder='Address of Realms: N4DpBDjivrRYEegGW49tSZDnzyQSWzhwAzXqGhHY5dg'
                value={data?.realms}
                onChange={(e: any) => {
                  onChange({
                    data: {
                      ...data,
                      realms: e.target.value,
                    },
                  });
                }}
              />
            ...
            <Space direction='vertical' size='small' className='w-full'>
              ...
              <Input
                className='w-full'
                placeholder='Address of the Governace Propgram: GovER5Lthms3bLBqWub97yVrMmEogzX7xNjdXpPPCVZw'
                value={data?.governance_program}
                onChange={(e: any) => {
                  onChange({
                    data: {
                      ...data,
                      governance_program: e.target.value,
                    },
                  });
                }}
              />
            ...
            <Space direction='vertical' size='small' className='w-full'>
              ...
              <Input
                className='w-full'
                placeholder='Address of the Mint Proposal: FQ3uRgs1YEuQHkT3xaQd61DUpuuFxTyZQQa42wAgvLmm'
                value={data?.proposal_mint}
                onChange={(e: any) => {
                  onChange({
                    data: {
                      ...data,
                      proposal_mint: e.target.value,
                    },
                  });
                }}
              />
