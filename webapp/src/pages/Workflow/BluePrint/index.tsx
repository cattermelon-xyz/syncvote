...
const BluePrint = () => {
  ...
  const navigateToNewMission = (thisVersion: any) => {
    navigate(
      `/${orgIdString}/${createIdString(
        workflow.title,
        workflow.id.toString()
      )}/${createIdString(thisVersion.version, thisVersion.id)}/new-mission`
    );
  };
                  ...
                  <Popover
                    ...
                    content={
                      <Space direction='vertical' size='middle'>
                        ...
                        {(version.status === 'DRAFT' && version.recommended === false) && (
                          <Button
                            onClick={(e: any) => {
                              e.stopPropagation();
