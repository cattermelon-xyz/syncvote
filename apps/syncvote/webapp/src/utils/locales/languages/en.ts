export const LANG: any = {
  ...
  exploreTopTierTemplates: 'Explore top-tier templates',
  publishANewTemplate: 'Publish a new template',
  workflows: 'Workflows',
  logOut: 'Log out',
  createANewSpace: 'Create a new workspace',
  createANewWorkflow: 'Create a new workflow',
